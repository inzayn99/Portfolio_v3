                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"> something I've Build</h3>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="">
                            <form id="homeinfoForm" role="form" action="{{ route('homeinfo.update', $homeinfo->id) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <img id="coverPreview"
                                                ...
                                                src="{{ old('image', @$homeinfo->image) ? @$homeinfo->image : asset('storage/noimage.jpg') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <!--cover-img-->
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnailCover" class="form-control"
                                                    value="{{ old('image', @$homeinfo->image) }}" type="text"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" name="title" value="{{ $homeinfo->title }}">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <textarea name="description" id="summernote" rows="6" class="form-control">{{ $homeinfo->description }}</textarea>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#homeinfoForm').on('submit', function(e) {
