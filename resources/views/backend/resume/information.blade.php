                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"> Resume Information!</h3>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="">
                            <form id="resumeForm" role="form" action="{{ route('resume.update', $info->id) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <img id="coverPreview"
                                                ...
                                                src="{{ old('cover', @$info->cover) ? @$info->cover : asset('storage/noimage.jpg') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <!--cover-img-->
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnailCover" class="form-control"
                                                    value="{{ old('cover', @$info->cover) }}" type="text" name="cover"
                                                    onchange="loadCover()" readonly>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <textarea name="description" id="summernote" rows="6" class="form-control">{{ $info->description }}</textarea>
