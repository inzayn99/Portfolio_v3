                ...
                <div class="col-md-12" bis_skin_checked="1">
                    ...
                    <div class="box box-primary" bis_skin_checked="1">
                        <div class="box-header ptbnull" bis_skin_checked="1">
                            <h3 class="box-title titlefix">Client List</h3>
                            <div class="box-tools pull-right" bis_skin_checked="1">
                                <a href="{{ route('clients.create') }}" class="btn btn-primary btn-sm addvisitor"><i
                                        class="fa fa-plus"></i> Add New</a>
                            </div>
                        </div>
                        <div class="box-body" bis_skin_checked="1">
                            <div class="download_label" bis_skin_checked="1">Clients List</div>
                                                ...
                                                @else
                                                    @foreach ($clients as $data)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><a href="{{ route('clients.edit', $data->id) }}">{{ Str_limit($data->title, 100 ?? 'NA') }}</a></td>
