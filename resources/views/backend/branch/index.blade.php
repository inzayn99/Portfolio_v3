                    ...
                    <div class="box box-primary" bis_skin_checked="1">
                        <div class="box-header ptbnull" bis_skin_checked="1">
                            ...
                            <div class="box-tools pull-right" bis_skin_checked="1">
                                <a href="{{ route('branch.create') }}" class="btn btn-primary btn-sm addvisitor"><i
                                        class="fa fa-plus"></i> Create a New</a>
                            </div>
                        </div>
                        <div class="box-body" bis_skin_checked="1">
                            <div class="download_label" bis_skin_checked="1">Branch List</div>
                            <div class="table-responsive mailbox-messages" bis_skin_checked="1">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"
                                                ...
                                                @else
                                                    @foreach ($branch as $data)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><a href="{{ route('branch.edit', $data->id) }}">{{ Str_limit($data->title, 200 ?? 'NA') }}</a></td>
                                    ...
                                    <div class="dataTables_info" id="DataTables_Table_0_info" role="status"
                                        aria-live="polite" bis_skin_checked="1">Records: {{ $branch->firstItem() }}
                                        to
                                        {{ $branch->lastItem() }} of {{ $branch->total() }}</div>
