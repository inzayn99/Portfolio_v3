                ...
                <div class="col-md-12" bis_skin_checked="1">
                    ...
                    <div class="box box-primary" bis_skin_checked="1">
                        <div class="box-header ptbnull" bis_skin_checked="1">
                            <h3 class="box-title titlefix">Blogs List</h3>
                        ...
                        <div class="box-body" bis_skin_checked="1">
                            <div class="download_label" bis_skin_checked="1">Blogs List</div>
                                                ...
                                                @else
                                                    @foreach ($blogs as $blog)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><img src="{{ $blog->cover_image }}" alt="" style="max-height:20px; width:30px; border-radius: 5px"></td>
                                                            <td><a href="{{ route('blogs.edit', $blog->id) }}">{{ Str_limit($blog->title, 100 ?? 'NA') }}</a></td>
