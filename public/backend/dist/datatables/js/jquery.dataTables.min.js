(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, G) { E || (E = window);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "<div align='center'>No data available in table <br /> <br /><img src='https://smart-hospital.in/shappresource/images/addnewitem.svg' width='150'><br /><br /> <span class='text-success bolds'><i class='fa fa-arrow-left'></i> Add new record or search with different criteria.</span><div>",
    ...
    var Kb = m.ext.pager;
    h.extend(Kb, {
        simple: function() { return ["<i class='fa fa-angle-right'></i>", "<i class='fa fa-angle-left'></i>"] },
