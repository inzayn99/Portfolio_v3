...
function (r) {
    ...
    $("#home-card").length && $(".top-menu").on("click", "a", function () {
        var t = $(".lines-grid"),
            ...
            r = $(".top-menu li"),
            o = $(this).closest("li");
        return !o.hasClass("active") & $("#home-card").length && (r.removeClass("active"), o.addClass("active"), $(n).removeClass("active"), $(i).addClass("active")), !1
